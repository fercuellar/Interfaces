...
const (
	TestApi_Echo_FullMethodName    = "/coords.TestApi/Echo"
	TestApi_GetUser_FullMethodName = "/coords.TestApi/GetUser"
)
...
const (
	CoordsComm_GetCoords_FullMethodName = "/coords.CoordsComm/getCoords"
)
